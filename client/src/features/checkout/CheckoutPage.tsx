...
import type { StripeElementType } from "@stripe/stripe-js/dist/stripe-js/elements-group";
...
export default function CheckoutPage() {
    ...
    function onCardChangeInput(event: any) {
        setCardState({
            ...cardState,
            elementError: {
    ...
    function getStepContent(step: number) {
        switch (step) {
            ...
            case 1:
                return <Review />;
            case 2:
                return <PaymentForm cardState={cardState} onCardChangeInput={onCardChangeInput} />;
            default:
                ...
                <>
                    {activeStep === steps.length ? (
                        <>
                            ...
                            {paymentSucceeded ? (<Typography variant="subtitle1">
                                Your order number is {orderId}. We not have emailed your order
